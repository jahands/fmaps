            ...
            buildMap: function(instance) {
                ...
                if(instance.countLayers===2&&false) {
                    ...
                    if (instance.countLayers > 1) {
                        L.control.layers(instance.layers, {}, { collapsed: instance.meta.meta.map.options.collapseLayerList }).addTo(instance.map).setPosition('bottomright');
                    }
                }
                ...
                for(var e in instance.markers) {
                    instance.markers.hasOwnProperty(e) && instance.markers[e].addTo(instance.map);
                }
            },
